...
import common.generate_plasticity_status
import pdb
...
def choose_pipeline(choice):
    ...
    if choice == 'n-choice':
        ...
        import nchoice_arky.init_params_nchoice as par
        import nchoice_arky.popconstruct_nchoice as popconstruct
        import nchoice_arky.interface_nchoice as interface
